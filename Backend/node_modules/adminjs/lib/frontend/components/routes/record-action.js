...
const RecordAction = () => {
  ...
  const fetchRecord = () => {
    ...
    api.recordAction(params).then(response => {
      var _response$data$record, _response$data$record2, _response$data$record3, _response$data$record4;

      if (response.data.notice && response.data.notice.type === 'error') {
        addNotice(response.data.notice);
      }

      if (!((_response$data$record = response.data.record) !== null && _response$data$record !== void 0 && (_response$data$record2 = _response$data$record.baseError) !== null && _response$data$record2 !== void 0 && _response$data$record2.type) || ![_errorType.ErrorTypeEnum.App, _errorType.ErrorTypeEnum.NotFound, _errorType.ErrorTypeEnum.Forbidden].includes((_response$data$record3 = response.data.record) === null || _response$data$record3 === void 0 ? void 0 : (_response$data$record4 = _response$data$record3.baseError) === null || _response$data$record4 === void 0 ? void 0 : _response$data$record4.type)) {
