...
class ApiController {
  ...
  async recordAction(originalRequest, response) {
    ...
    const idProperty = Object.values((_actionContext$resour = actionContext.resource.decorate().properties) !== null && _actionContext$resour !== void 0 ? _actionContext$resour : {}).find(p => p.isId());
